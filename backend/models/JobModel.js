...
const JobSchema = new mongoose.Schema(
  {
    ...
    finished: {
      ...
      Rate_unit: { type: String, default: "" },
      Peyment_Status: { type: String, default: "Pending" },
      Peyment_Mode: { type: String, default: "Pending" },
      Total_Amount: { type: String, default: "0" },
      Advance: { type: String, default: "0" },
      Delivery_Charge: { type: String, default: "0" },
      Discount: { type: String, default: "0" },
      Due_Amount: { type: String, default: "0" },

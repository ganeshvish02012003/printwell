    ...
    <div>
      ...
      <div className="flex">
        <div className="w-3/4 p-2">
          <div className="rounded-xl">
            ...
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="jobName" className="col-span-1 text-sm pl-1 flex items-center">
                Job Name:
              </label>
              <input
                type="text"
            ...
            {/* Category & Quantity */}
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="category" className="col-span-1 text-sm pl-1 flex items-center">
                Category:
              </label>
              <select
                name="category"
              ...
              <label htmlFor="quantity" className="col-span-1 text-sm pl-1 mx-4 flex items-center">
                Quantity:
              </label>
              <input
                type="number"
            ...
            {/* Job Size & Pages */}
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="jobSize" className="col-span-1 text-sm pl-1 flex items-center">
                Job Size:
              </label>
              <select
                name="jobSize"
                ...
                className="p-1 bg-slate-50 border text-sm rounded col-span-2"
              >
                <option value="" disabled>Select Job Size</option>
              ...
              <label htmlFor="pages" className="col-span-1 text-sm pl-1 ml-2 flex items-center">
                No. of Pages:
              </label>
              <input
                type="number"
            ...
            {/* Color & Ink */}
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="color" className="col-span-1 text-sm pl-1 flex items-center">
                Color:
              </label>
              <select
                name="color"
              ...
              <label htmlFor="ink" className="col-span-1 text-sm pl-1 mx-8 flex items-center">
                Ink:
              </label>
              <select
                name="ink"
              ...
              >
                ...
                <option value="multi" disabled>Multi Color</option>
              </select>
            </div>

            {/* Paper & Description */}
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="paperName" className="col-span-1 text-sm pl-1 flex items-center">
                Paper Name:
              </label>
              <select
                name="paperName"
              ...
              <label htmlFor="paperColor" className="col-span-1 text-sm pl-1 ml-2 flex items-center">
                Paper Color:
              </label>
              <select
                name="paperColor"
            ...
            {/* Job Description */}
            <div className="grid grid-cols-6 mb-2">
              <label htmlFor="job_description" className="col-span-1 text-sm pl-1 flex items-start">
                Description:
              </label>
              <textarea
        ...
        <div className="w-1/4 px-2 pt-1">
          <label htmlFor="sampleFile" className="block">Sample File:</label>
          <input
            type="file"
            id="sampleFile"
            ...
            {previewFile ? (
              <>
                {previewFile.endsWith(".pdf") ? (
                  <iframe src={previewFile} className="w-full h-full" title="PDF preview" />
                ) : (
                  <img
                    src={previewFile}
                    alt="Sample Preview"
  ...
  <MdDeleteForever size={16} />
      ...
      {modalOpen && (
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="bg-white relative rounded-lg overflow-y-auto max-w-screen-xl w-full h-screen">
            <button onClick={closeModal} className="absolute top-4 right-4 text-red-400 hover:text-red-500">
            ...
            <div className="flex justify-center items-center h-full p-4">
              {previewFile?.endsWith(".pdf") ? (
                ...
                <img
                  src={previewFile}
                  alt="Zoomed Preview"
                  onDoubleClick={() => setViewMode(viewMode === "fit" ? "max" : "fit")}
                  className={`object-contain mx-auto cursor-zoom-in ${
                    viewMode === "fit" ? "max-h-screen max-w-full" : "h-full w-auto"
                  }`}
                />
              )}
            </div>
          ...
          >
            {previewFile ? (
              <>
                ...
                <div className="absolute top-1 right-1 flex space-x-1">
                  <button onClick={openModal} className="bg-white p-1 rounded shadow hover:bg-slate-200">
                    <FaEye size={16} />
                  </button>
                  <button onClick={handleDeleteFile} className="bg-white p-1 rounded shadow hover:bg-red-200">
                    <MdDeleteForever size={16} />
                  </button>
                </div>
              </>
